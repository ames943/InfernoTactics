...
from infernotactics.domain.resources import GROUND_RESOURCE_TYPES, RESOURCE_TYPES  # noqa: E402
from infernotactics.policy.inference import (  # noqa: E402
    DEFAULT_MAX_DISPATCH_SLOTS,
    forward_policy,
)
from infernotactics.policy.models.relative_model import RelativeInfernoModel  # noqa: E402
from infernotactics.policy.targets import TARGET_TYPES, decode_action  # noqa: E402
from infernotactics.simulation.fire_sim import (  # noqa: E402
    BLAZE,
    BURNED_OUT,
    FUEL,
    SAFE,
...
def run_episode(env, model, delay_ticks, ig_row=None, ig_col=None, seed=9100, scenario="anchor"):
    ...
    while not done or post_ticks < POST_EPISODE_TICKS:
        ...
        with torch.no_grad():
            logits, value, _cls, target_zones, _target_features = forward_policy(
...
async def startup():
    ...
    t0 = time.time()
    env = InfernoEnv(
        grid_static_path=GRID_STATIC_PATH,
