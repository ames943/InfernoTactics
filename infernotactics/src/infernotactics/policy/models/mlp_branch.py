"""
MLP branch: consumes the environment scalar observation (wind speed/
direction, humidity, resources available per type, elapsed ticks --
infernotactics.domain.observations.flatten_scalars() gives the fixed-order vector) and produces
