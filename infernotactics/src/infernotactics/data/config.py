...
FUEL_MODEL_PATH = os.path.join(DATA_DIR, "landfire_fbfm40_2024.tif")
SOURCE_MANIFEST_PATH = os.path.join(DATA_DIR, "source_manifest.json")
LEGACY_GRID_STATIC_PATH = os.path.join(DATA_DIR, "grid_static_legacy_heuristic.npy")
LEGACY_GRID_META_PATH = os.path.join(DATA_DIR, "grid_meta_legacy_heuristic.json")
